...
export const PHYSICAL_CHILD: AccordionItem[] = [
    ...
    { id: 3 as string | number,  label: 'Product Detail' as string, icon: undefined as string | undefined, route: '/product-detail' as string | undefined, children: undefined as AccordionItem[] | undefined, badge: 3 as (string | number) | undefined, },
    { id: 4 as string | number,  label: 'Add Product' as string, icon: undefined as string | undefined, route: '/add-product' as string | undefined, children: undefined as AccordionItem[] | undefined, badge: 4 as (string | number) | undefined, },
];