...
export const PRODUCTS_CHILD: AccordionItem[] = [
    ...
    { id: 1 as string | number,  label: 'Digital' as string, icon: undefined as string | undefined, route: undefined as string | undefined, children: undefined as AccordionItem[] | undefined, badge: 1 as (string | number) | undefined, },
